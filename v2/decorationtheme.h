...
public:
    ...
    qreal buttonWidthMinimize() const;
    qreal buttonWidthMaximizeRestore() const;
    qreal buttonWidthClose() const;
    qreal buttonWidthAllDesktops() const;
    qreal buttonWidthKeepAbove() const;
    qreal buttonWidthKeepBelow() const;
    qreal buttonWidthShade() const;
    qreal buttonWidthHelp() const;
    qreal buttonWidthMenu() const;
    qreal buttonWidthAppMenu() const;
